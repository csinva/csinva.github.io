...
1. *process model* - framework for delivering technology
...
1. a *quality focus* - bedrock that supports software engineering
...
1. *dynamic systems development method* - similar to xp
...
1. *functional model* - describes operations that will be applied to manipulate content and describes other processing functions that are independent of content but necessary to the end user
2. *configuration model* - environment and infrastructure in which the app resides

- server-side and client-side

1. *navigation modeling* - defines overall navigation strategy for the app
