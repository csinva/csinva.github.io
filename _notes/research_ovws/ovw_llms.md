...
- semi-autonomous AI scientists systems
  ...
  - HACHI: Human-AI Co-design for Clinical Prediction Models ([feng...singh, 2026](https://www.nature.com/articles/s41746-026-02838-5))
    - Principal Trait Analysis: Towards Deriving "Skills" in Human-AI Collaboration ([mcnichols, du & lan, 2026](https://arxiv.org/abs/2608.11460)) - run PCA on on collaborative sessions and annotate clusters with LLM judge
